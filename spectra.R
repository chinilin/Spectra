...
# Savitzkyâ€“Golay smoothing. Savitzky-Golay filtering is a very common
...
# SG filtering + compute continuumâ€“removed values. The continuum removal technique was introduced by as an effective method to highlight absorption
...
# SG filtering + detrend normalization. The SNVâ€“Detrend further accounts for wavelength-dependent scattering effects (variation in curvilinearity
# between the spectra). After a SNV transformation, a 2ndâ€“order polynomial is fit to the spectrum
...
grid.arrange(plot(varImp(object = mod2), main = "PCR - Variable Importance (FD spectra)",
                  top = 15, ylab = "Ïåðåìåííàÿ", xlab = "Çíà÷èìîñòü"),
             plot(varImp(object = mod5), main = "Randon Forest - Variable Importance (FD spectra)",
                  top = 15, ylab = "Ïåðåìåííàÿ", xlab = "Çíà÷èìîñòü"),
             ncol = 2, nrow = 1)
